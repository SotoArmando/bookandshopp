...
function Pageitempreview({upstreamUser}) {
    ...
    return [<div className="col center ">
        <span className="allsize corebox_15 contain norepeat" style={{
            backgroundImage:`url(${url0(pictureid)})`
        }}/>
    </div>,
    <div className="absolute right bodyheight back_2 corebox_x15 col border_l3 pad_22 pad_l0 pad_r33">
