...
const newrecipe = Object.entries({
  name: {
    holder: 'Name',
  },
  duration: {
...
const newgrocerylist = Object.entries({
  name: {
    holder: 'Name',
  },
  ingredients: {
...
const newcomment = Object.entries({
  author: {
    holder: 'Author',
    required: false,
    regex: '',
...
const settingskeys = ['object', 'limit', 'holder', 'type', 'required', 'regex'];
